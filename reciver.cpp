...
int main(){
    ...
    ifstream file("out.out");
    char buff[FRAME_SIZE];
    file.read(buff, FRAME_SIZE);
    file.close();
    ...
    string toJSON[25] = {"const","frame", "gps_x","gps_y","gps_h","gps_meta","tmp_1","tmp_2","tmp_3",
    "hum","bat","part_1","part_2","part_3","part_flow","press","gyro_x","gyro_y","gyro_h",
    "acc_x","acc_y","acc_h","dbi","state","valid"};
    // "id": 1,
    //   "frame": 1,
    //   "gps_x": "13230",
    //   "gps_y": "43894",
    ...
    //cout<<"{\n";
    POSTdata+="{\n";
    for (int i = 1; i < 25; i++) //bez const wypisuje
    {
